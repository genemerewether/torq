...
directories = ["Data/HorizontalFlight/log001"]
...
covSens = np.diag([1e-4, 1e-4, 1e-4, 1e-4, 1e-4, 1e-4, 3e-5, 3e-5, 3e-5, 3e-5, 1e-4, 1e-4, 1e-4])
...
if loadTheta:
    ...
    # Aerodynamic
    Theta.loc['Cq'] = {'value': 2.2e-10, 'stddev':0.0, 'estimate': False}
    ...
    Theta.loc['Cdh'] = {'value': 0.0, 'stddev':0.0, 'estimate':True}
    Theta.loc['Cdxy'] = {'value': 0.00, 'stddev':0.0, 'estimate':True}
    Theta.loc['Cdy'] = {'value': 0, 'stddev':0.0, 'estimate': False}
    Theta.loc['Cdz'] = {'value': 0.00, 'stddev':0.0, 'estimate':True}
